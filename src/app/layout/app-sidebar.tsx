...
import { Home, LayoutDashboard, List, Upload, Target, Package2, Settings, CreditCard as CreditCardIcon, Landmark as BankIcon, Car, AreaChart, BarChart3, ClipboardCheck, Tags, LineChart } from 'lucide-react';
