...
export default function WebSearchPage() {
  ...
  const handleSearch = async () => {
    ...
    setLoading(true);
    try {
      console.log('[Web Search] Iniciando pesquisa web...');
      ...
      console.log('[Web Search] Encontrados', webData.totalResults, 'produtos');
      setResults(webData);
    } catch (error: any) {
      toast({
        variant: 'destructive',
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Pesquise preços de produtos no mercado atual
          </CardDescription>
        </CardHeader>
