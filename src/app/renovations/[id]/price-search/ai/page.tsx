...
import { Search, Loader2, Star, Package, Sparkles } from 'lucide-react';
...
export default function AiSearchPage() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      console.log('[AI Search] Iniciando pesquisa web...');
      ...
      console.log('[AI Search] Pesquisa web concluída, encontrados', webData.totalResults, 'produtos');

      // Passo 2: Pesquisa IA
      if (webData.totalResults > 0) {
        console.log('[AI Search] Iniciando análise com IA...');
        try {
          ...
          if (aiResponse.ok) {
            ...
            console.log('[AI Search] Análise com IA concluída');
          }
        } catch (error) {
          console.warn('[AI Search] Erro ao gerar insights com IA:', error);
        }
      }
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Pesquise preços e receba análise inteligente com recomendações
          </CardDescription>
        </CardHeader>
        ...
        <>
          ...
          {results.aiInsights && (
            <Card className="bg-gradient-to-r from-blue-50 to-purple-50 border-blue-200">
              ...
              <CardContent>
                <p className="text-sm text-gray-700 leading-relaxed">{results.aiInsights}</p>
              </CardContent>
            </Card>
          )}
